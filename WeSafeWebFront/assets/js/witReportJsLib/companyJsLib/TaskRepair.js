$(document).ready(function () {
    ...
    var oRepair = new RepairLineChart(areaId);
    oRepair.drawOverdue();
    oRepair.drawNotStart();
    oRepair.drawDone();
    oRepair.drawInProgress();
...
var RepairLineChart = function (areaId) {
    var oRepair = new Object();
    oRepair.svrUrl = RptCommon.Host + "api/company/RepairReport/FindRepairDailyRate/" + areaId + "/";
    oRepair.drawOverdue = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawTemp(contentId, arr2, EchartsHelper.Task.Overdue, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
    ...
    oRepair.drawNotStart = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawTemp(contentId, arr2, EchartsHelper.Task.NotStart, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
    ...
    oRepair.drawDone = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawTemp(contentId, arr2, EchartsHelper.Task.Done, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
    ...
    oRepair.drawInProgress = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawTemp(contentId, arr2, EchartsHelper.Task.InProgress, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "api/company/RepairReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "api/company/RepairReport/FindLatestRepairCount/" + areaId;
        ...
        $.getJSON(this.svrUrl, function (data) {
            ...
            $.each(data, function (idx, item) {
                ...
                if (txt != "") {
                    ...
                    $("#RepairpieItems").append("<li style='margin-top: 30px;'><p>" + txt + "</p><div>" + item.value + "</div></li>");
                }
            });

            EchartsHelper.drawRing("Repair_pie", arrName, {
                radius: ['30%', '50%'],
                //label: {
                //    normal: {
                //        show: true,
