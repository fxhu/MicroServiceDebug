$(document).ready(function () {
    ...
    var oMaintain = new MaintainLineChart(areaId);
    oMaintain.drawOverdue();
    oMaintain.drawNotStart();
    oMaintain.drawDone();
    oMaintain.drawInProgress();
...
var MaintainLineChart = function (areaId) {
    var oMaintain = new Object();
    oMaintain.svrUrl = RptCommon.Host + "api/company/MaintainReport/FindMaintainDailyRate/" + areaId + "/";
    oMaintain.drawOverdue = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawLine(contentId, arr2, EchartsHelper.Task.Overdue, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
    ...
    oMaintain.drawNotStart = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawLine(contentId, arr2, EchartsHelper.Task.NotStart, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
    ...
    oMaintain.drawDone = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawLine(contentId, arr2, EchartsHelper.Task.Done, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
    ...
    oMaintain.drawInProgress = function () {
        ...
        $.getJSON(this.svrUrl + statusVal, function (data) {
            ...
            EchartsHelper.drawLine(contentId, arr2, EchartsHelper.Task.InProgress, {
                title: txt + "率",
                data: arr1
            }, {
                    title: txt
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "api/company/MaintainReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "api/company/MaintainReport/FindLatestMaintainCount/" + areaId;
        ...
        $.getJSON(this.svrUrl, function (data) {
            ...
            $.each(data, function (idx, item) {
                ...
                if (txt != "") {
                    ...
                    $("#MaintainpieItems").append("<li style='margin-top: 30px;'><p>" + txt + "</p><div>" + item.value + "</div></li>");
                }
            });

            EchartsHelper.drawRing("Maintain_pie", arrName, {
                radius: ['30%', '50%'],         
                data: jsonData
            }, {
                    title: "保养",
