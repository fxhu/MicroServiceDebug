...
var HillChart = function (areaId) {
    ...
    oHill.svrUrl = RptCommon.Host + "api/company/HiddenDangerReport/FindDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "api/company/HiddenDangerReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "api/company/HiddenDangerReport/FindLatestHiddenDangerCount/" + areaId;
