...
var HomeDevice = function (areaId) {
    ...
    oDevice.svrUrl = RptCommon.Host + "api/company/DeviceReport";
    ...
    oDevice.ShowDeviceLine = function () {
        ...
        $.getJSON(this.svrUrl + "/FindDailyRate/" + "["+areaId+"]" + "/" + statusVal, function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var ymd = RptCommon.formatData(data[i].timestamp);
                arr2.push({
                    value: ymd,
                    textStyle:{
                        align:'left'
...
var HomeAlarm = function (areaId) {
    ...
    oAlarm.svrUrl = RptCommon.Host + "api/company/WarningReport";
...
var HomeHidden = function (areaId) {
    ...
    oHidden.svrUrl = RptCommon.Host + "api/company/HiddenDangerReport";
...
var HomePartrol = function (areaId) {
    oPartrol = new Object();
    oPartrol.svrUrl = RptCommon.Host + "api/company/PatrolReport";
...
var HomeRepair = function (areaId) {
    oRepair = new Object();
    oRepair.svrUrl = RptCommon.Host + "api/company/RepairReport";
...
var HomeCheck = function (areaId) {
    oCheck = new Object();
    oCheck.svrUrl = RptCommon.Host + "api/company/CheckReport";
...
var HomeMaintain = function (areaId) {
    ...
    oMaintain.svrUrl = RptCommon.Host + "api/company/MaintainReport";
