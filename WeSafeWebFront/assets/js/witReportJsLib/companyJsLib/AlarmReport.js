...
var AlarmBarChart = function (areaId) {
    ...
    oAlarm.svrUrl = RptCommon.Host + "api/company/WarningReport/FindDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "api/company/WarningReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "api/company/WarningReport/FindLatestWarningCount/" + areaId;
    ...
    oPie.drawCount = function () {
        var url = RptCommon.Host + "api/company/WarningReport/FindLatestWarningCountList/" + areaId;
