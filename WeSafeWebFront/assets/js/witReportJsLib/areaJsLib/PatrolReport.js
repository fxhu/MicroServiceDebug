...
var PatrolLineChart = function (areaId) {
    ...
    oPatrol.svrUrl = RptCommon.Host + "/api/PatrolReport/FindDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    ...
    oCompare.svrUrl = RptCommon.Host + "/api/PatrolReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "/api/PatrolReport/FindLatestWarningCount/" + areaId;
