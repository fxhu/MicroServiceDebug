...
var CheckLineChart = function (areaId) {
    ...
    oCheck.svrUrl = RptCommon.Host + "/api/CheckReport/FindCheckDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "/api/CheckReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "/api/CheckReport/FindLatestCheckCount/" + areaId;
