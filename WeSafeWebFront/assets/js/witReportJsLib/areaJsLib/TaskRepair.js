...
var RepairLineChart = function (areaId) {
    ...
    oRepair.svrUrl = RptCommon.Host + "/api/RepairReport/FindRepairDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "/api/RepairReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "/api/RepairReport/FindLatestRepairCount/" + areaId;
