...
var DeviceLineChart = function (areaId) {
    ...
    oDevice.svrUrl = RptCommon.Host + "/api/DeviceReport/FindDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "/api/DeviceReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "/api/DeviceReport/FindLatestDeviceCount/" + areaId;
