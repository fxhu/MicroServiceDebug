...
var MaintainLineChart = function (areaId) {
    ...
    oMaintain.svrUrl = RptCommon.Host + "/api/MaintainReport/FindMaintainDailyRate/" + areaId + "/";
...
var CompareChart = function (areaId) {
    oCompare = new Object();
    oCompare.status = "1";
    oCompare.svrUrl = RptCommon.Host + "/api/MaintainReport/FindTHRateCompare/" + areaId;
...
var PieChart = function (areaId) {
    var oPie = new Object();
    oPie.svrUrl = RptCommon.Host + "/api/MaintainReport/FindLatestMaintainCount/" + areaId;
