(function () {
    var controllerId = 'app.views.AddPlan';
    angular.module('app').controller(controllerId, [
        '$scope', '$timeout', 'abp.services.app.patrol', function ($scope, $timeout, patrolService) {
            ...
            //patrolService.savePointItem({
            //    TaskId: 54, PointCheckItem:'{"name":"温感888888","typeId":"71","items":[{"selectItems":["正常","不正常"],"type":3,"value":0,"content":"外观"}]}',
            //    AssestName: 'PO1B01F01S033-烟感888888', isNormal: true, AssestId: '5df9b29c-e938-11e7-bd1f-005056b619d6'
            //});
            //patrolService.getTaskAndItemsById({
            //    Id: 54
            //}).then(function (result) {
            //    var data = result;
            //    });
            //patrolService.getTaskListAndAllItems({}).then(function (result) {
            //    var data = result;
            //});            
            ...
            vm.save = function () {
                ...
                var p = {
                    GroupIds: selectgs, TypeGroupIds: selecttgs, AreaIds: JSON.stringify(areaids),
                ...
                patrolService.addPlan(p).then(function () {
