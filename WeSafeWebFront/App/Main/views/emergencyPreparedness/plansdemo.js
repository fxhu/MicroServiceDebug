(function () {
    var controllerId = 'app.views.plansdemo';
    angular.module('app').filter('to_trusted', ['$sce', function ($sce) {
        ...
        '$scope', '$location', '$anchorScroll', 'abp.services.app.plan', function ($scope, $location, $anchorScroll, planService) {
          //  $anchorScroll.yOffset = 300;
            ...
            planService.getSection(vm.Id).then(function (result) {
