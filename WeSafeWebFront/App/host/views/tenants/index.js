(function () {
    appModule.controller('host.views.tenants.index', [
        ...
        function ($scope, $stateParams, $uibModal, uiGridConstants, tenantService, commonLookupService, lookupModal) {
                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate:
                            ...
                            '      <li><a ng-click="grid.appScope.unlockTenantAdmin(row.entity)">' + app.localize('Unlock') + '</a></li>' +
                            '    </ul>' +
                            '  </div>' +
                            '</div>'
                    },
            ...
            vm.unlockTenantAdmin = function (tenant) {
                tenantService.unlockTenantAdmin({
                    id: tenant.id
                }).then(function () {
                    abp.notify.success(app.localize('UnlockedTenandAdmin', tenant.name));
                });
            };
