                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate:
                            ...
                            '  <button class="btn btn-default btn-xs" ng-click="grid.appScope.selectItem(row.entity)"><i class="fa fa-check"></i> ' + app.localize('选择') + '</button>' +
                            '</div>'
                    },
                    {
    ...
    appModule.factory('lookupModal', [
        ...
        function ($uibModal) {
            function open(lookupOptions) {
                $uibModal.open({
                    templateUrl: '/App/common/views/common/lookupModal.html',
